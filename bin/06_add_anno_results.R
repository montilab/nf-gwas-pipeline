...
annot.results <- annot.results %>%
	select ("snpID", "chr", "pos", "REF", "ALT", contains("Imputation_Rsq"), contains("Imputation_mark"), contains("Score"), contains("EST"), "pval", contains("SPA"), contains("PVE"), contains("VAR"), "N", contains("n.case"), contains("n.control"), contains("MAC"), "missing.rate", contains("caf"), contains("dosage"), contains("refGene"))
